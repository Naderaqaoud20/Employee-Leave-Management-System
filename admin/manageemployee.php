                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $query = "SELECT EmpId,FirstName,LastName,Department,Status,RegDate,id from  tblemployees";
    $result = mysqli_query($con,$query);
    $cnt=1;
...
if($stats){
                                            ...
                                            <td><a href="editemployee.php?empid=<?php echo $row['id'];?>"><i class="material-icons">mode_edit</i></a>
                                        <?php if($row['Status']==1)
 {?>
                                        <a href="manageemployee.php?inid=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this Employe?');"" > <i class="material-icons" >clear</i>
<?php } ?></td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
